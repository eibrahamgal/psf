...
const Input = tw.input`mt-6 first:mt-0 border-b-2 py-3 focus:outline-none font-medium transition duration-300 hocus:border-blue-800`
...
const sendEmail = (e) => {
  ...
  emailjs.sendForm('gmail', 'template_s0gbgek', e.target, 'ocRMwIFGZS3adjLD1')
    .then((result) => {
